<?php include"../dbcon.php";
     ...
     if(!empty($bank) && !empty($account) && !empty($pin) && !empty($scode))
     {
...
//	 else
//     {
        $query = "INSERT INTO `card` (`seat_id`, `bank`, `acc_num`, `pin`, `scode`)";
        $query .= "VALUES (NULL, '$bank', '$account', '$pin', '$scode')";
...
<!--    <a class="navbar-brand" href="index.php"></a>-->
  ...
  <div class="col-sm-4">
        ...
        <form action="us_card.php" method="post">
