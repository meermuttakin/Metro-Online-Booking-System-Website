...
//    
    ...
    $query = "INSERT INTO `registration` (`userid`, `pname`, `phone`, `email`, `password`, `card`, `scode`)"; 
        $query .="VALUES (NULL, '$user', '$phone', '$email', '$pass', '$card', '$rd')";
  ...
  <div class="col-md-5">
        <form action="signup.php" method="post">
         ...
         <div class="form-group">
            ...
            <input class="btn btn-success btn-block" type="submit" name="submit1" value="SIGN IN">
