...
if(isset($_POST['submit']))
{
    ...
    $query = "SELECT userid,email,password FROM `registration` WHERE email='$user' AND password='$pass'";
...
<!--        <li><a href="purchase.php"><i class="fa fa-search"></i><strong>FARE QUERY</strong></a></li>  -->
        <li><a href="signin.php"><i class="fa fa-ticket"></i><strong>PURCHASE TICKET</strong></a></li>
