<?php include"../dbcon.php";
    ...
    $query = "SELECT * FROM registration where password ='$nw'";
...
<br/>
    ...
    <center> <img src="../pic/ic3.png" class="img-responsive" alt="Avatar" style="width:200px">
                </center>
    <br>
...
-->
    ...
    <tbody>
        ...
        <?php 
					...
					while($row=mysqli_fetch_assoc($res))
					{
                        ...
                        echo '<tr><th>USER NAME</th><td>'.$pname .'</td></tr>';
                        echo '<tr><th>PHONE</th><td>'.$phone .'</td></tr>';	
                        echo '<tr><th>EMAIL</th><td>'.$email .'</td></tr>';	
                        echo '<tr><th>CARD NUMBER</th><td>'.$card .'</td></tr>';	
                        echo '<tr><th>SECURITY CODE</th><td>'.$scode .'</td></tr>';		
    ...
    <div class="row">
        <center>
        <a class="btn btn-primary " href="us_update.php" style="width:30%">UPDATE</a>
