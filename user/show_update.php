<?php include"../dbcon.php";
    ...
    $query = "SELECT * FROM registration where scode ='$nw'";
...
<div class="row">
  ...
  <div class="col-sm-11">
    ...
    <center><b><h1 style="color:green">TICKET BOOKING INFORMATION</h1></b>
	...
	<?php
        ...
        <td>
        <a class="btn btn-success" href="us_update.php?id=<?php echo $userid ?>"style="width:60%">UPDATE</a>
        </td>
        
        <td>
        <a class="btn btn-success" href="us_cancel.php?id=<?php echo $userid ?>"style="width:60%">DELETE</a>
        </td>
...
<!--    <a class="btn btn-success" href="index.php" style="width:10%">LOGOUT</a>-->
