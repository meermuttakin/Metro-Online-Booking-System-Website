<?php include"dbcon.php";
    ...
    $query = "SELECT * FROM purchase where scode='$nw'";
...
-->
    ...
    <tbody>
        ...
        <?php 
					...
					while($row=mysqli_fetch_assoc($res))
					{
                        ...
                        echo '<tr><th>TRAIN ID</th><td>'.$train .'</td></tr>';	
                        echo '<tr><th>DATE</th><td>'.$jd .'</td></tr>';	
                        echo '<tr><th>STATION FROM</th><td>'.$sfrom .'</td></tr>';	
                        echo '<tr><th>STATION TO</th><td>'.$sto .'</td></tr>';	
    ...
    <h3  style="color:green">.........................PLEASE KEEP YOUR SECURITY CODE SAFE AND SAVE.........................</h3>
    ...
    <div class="container">
    <div class="row">
        <a class="btn btn-primary " href="update.php" style="width:30%">UPDATE</a>
        <a class="btn btn-danger " href="cancel.php"style="width:30%">CANCEL</a>
        <a class="btn btn-success" href="contact.php"style="width:30%">FARE QUERY</a>
    </div>
    </div>
