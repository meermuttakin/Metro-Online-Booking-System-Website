...
//    }
     ...
     {
         $sql="UPDATE registration SET pname='$pname', phone=$phone, email='$email', password='$password' WHERE scode=$card";
	 ...
	 if(!$result)
	 {
		...
		else
		{
            ...
            header('Location: user/success1.php');
		}
     }
  ...
  <div class="container-fluid">
    ...
    <div class="col-xs-6">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
             <label for="scode">CARD NUMBER : </label>
