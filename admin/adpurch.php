...
-->
  ...
  <div class="col-sm-10">
	...
	<?php
        ...
        <td>
        <a class="btn btn-success" href="adpurch_del.php?id=<?php echo $userid ?>"style="width:60%">UPDATE</a>
        </td>
        
        <td>
        <a class="btn btn-success" href="adpurch_del.php?id=<?php echo $userid ?>"style="width:60%">DELETE</a>
        </td>
