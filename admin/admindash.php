...
<!--    <a class="navbar-brand" href="index.php"></a>-->
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="admindash.php"><i class="fa fa-home"></i><strong>HOME</strong></a></li>
        <li><a href="admindash.php"><i class="fa fa-users"></i><strong>DASHBOARD</strong></a></li>
        <li><a href="adreg.php"><i class="fa fa-road"></i><strong>USERS</strong></a></li>  
        <li><a href="adpurch.php"><i class="fa fa-ticket"></i><strong>TICKET</strong></a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              ...
              <li><a href="adchange_pass.php">CHANGE PASSWORD</a></li>
    ...
    <tbody>
        ...
        <?php 
					...
					while($row=mysqli_fetch_assoc($result))
					{
                        ...
                        echo '<tr><th>USER NAME</th><td>'.$name .'</td></tr>';
...
<!--    <center><h3  style="color:green">.........................PLEASE KEEP YOUR SECURITY CODE SAFE AND SAVE.........................</h3></center>-->
    ...
    <div class="row">
<!--
        <a class="btn btn-primary " href="purchase.php" style="width:30%">PURCHASE</a>
        <a class="btn btn-danger " href="cancel.php"style="width:30%">CANCEL</a>
        <a class="btn btn-success" href="index.php"style="width:30%">LOGOUT</a>
-->
    </div>
    </div>
