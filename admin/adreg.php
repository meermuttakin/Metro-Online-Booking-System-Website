...
-->
  ...
  <div class="col-sm-10">
	...
	<?php
        ...
        <td>
        <a class="btn btn-success" href="adreg_del.php?id=<?php echo $userid ?>" style="width:70%">UPDATE</a>
        </td>
        
        <td>
        <a class="btn btn-success" href="adreg_del.php?id=<?php echo $userid ?>" style="width:70%">DELETE</a>
        </td>
