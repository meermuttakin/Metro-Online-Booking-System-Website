...
if(isset($_POST['submit']))
{
    ...
    $query ="UPDATE admin set password='$pass' where password='$user'";
...
<!--    <a class="navbar-brand" href="index.php"></a>-->
  ...
  <div class="col-sm-4">
        ...
        <form action="adchange_pass.php" method="post">
        
           <center> <img src="../pic/ic1.jpg" alt="Avatar" style="width:200px">
                </center>
            ...
            <input class="btn btn-success btn-block" type="submit" name="submit" value="SIGN IN">
